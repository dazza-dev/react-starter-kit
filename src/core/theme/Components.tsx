...
const components = (theme: Theme): ThemeOptions["components"] => {
  return {
    ...
    MuiCard: {
      defaultProps: {
        elevation: config.borderCard ? 0 : 1,
      },
      styleOverrides: {
        root: {
          width: "100%",
          backgroundImage: "none",
          borderRadius: 7,
          ...(config.borderCard && { border: `1px solid ${theme.palette.divider}` }),
        },
      },
    },
    MuiCardContent: {
    ...
    MuiInputLabel: {
      styleOverrides: {
        outlined: {
          // The field is 48px tall, not the 56 MUI assumes: the label is recentered.
